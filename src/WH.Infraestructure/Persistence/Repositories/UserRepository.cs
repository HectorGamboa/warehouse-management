...
namespace WH.Infrastructure.Persistence.Repositories
{
    public class UserRepository(ApplicationDbContext context) : GenericRepository<User>(context), IUserRepository
    {
        ...
        public async Task<UserWithRoleAndPermissionsDto> GetUserWithRoleAndPermissionsAsync(int userId)
        {
            ...
            var menus = await (from mr in _context.ModuleRoles
                               join m in _context.Modules on mr.ModuleId equals m.Id
            ...
            var permissions = await (from rp in _context.RolePermissions
                                     ...
                                     join m in _context.Modules on p.MenuId equals m.Id
